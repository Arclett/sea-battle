...
export class Answer {
    ...
    addDeadShips(numberOfCell: number) {
        ...
        if (cells[numberOfCell + 1] !== undefined) {
            if (
                cells[numberOfCell + 1].style.background === this.wound &&
                !this.deadShips[this.countDeadShips].includes(numberOfCell + 1)
            ) {
        ...
        if (cells[numberOfCell + 10] !== undefined) {
            if (
                cells[numberOfCell + 10].style.background === this.wound &&
                !this.deadShips[this.countDeadShips].includes(numberOfCell + 10)
            ) {
    ...
    checkNextCell(index: number) {
        ...
        if (document.getElementsByClassName("enemyField")[index + 1] !== undefined) {
            if (
                (document.getElementsByClassName("enemyField")[index + 1] as HTMLElement).style.background ===
                this.wound
            ) {
                newIndex += 1;
        ...
        if (document.getElementsByClassName("enemyField")[index + 10] !== undefined) {
            if (
                (document.getElementsByClassName("enemyField")[index + 10] as HTMLElement).style.background ===
                this.wound
            ) {
                newIndex += 10;
                this.woundShipsWithBackgraund[this.countShips].push(newIndex);
