...
export class BackgroundAroundShips {
    ...
    renderAroundShipHorizontal(ship: number[]) {
        ...
        if (ship[0] < 9 && ship[0] + 1 !== 0 && ship[0] + ship.length - 2 !== 9) {
        ...
        } else if (ship[0] >= 90 && ship[0] !== 89 && ship[0] + ship.length - 2 !== 99) {
            ship.forEach((el) => {
                document.getElementById("field")?.childNodes.forEach((element, index) => {
                    if (index === el) {
                        (element as HTMLElement).style.background = this.backgroundAroundShip;
        ...
        } else if (ship[0] % 10 === 9 && ship[0] !== -1 && ship[0] !== 89) {
            ship.forEach((el, ind) => {
                if (ind !== 0) {
                    document.getElementById("field")?.childNodes.forEach((element, index) => {
                        if (index === el) {
            ...
            (ship[0] + ship.length - 2) % 10 === 9 &&
            ship[0] + ship.length - 2 !== 9 &&
            ship[0] + ship.length - 2 !== 99
        ) {
            ship.forEach((el, ind) => {
        ...
        } else if (ship[0] + ship.length - 2 === 9) {
            ship.forEach((el, ind) => {
                if (ind !== ship.length - 1) {
                    document.getElementById("field")?.childNodes.forEach((element, index) => {
                        if (index === el) {
        ...
        } else if (ship[0] + ship.length - 2 === 99) {
            ship.forEach((el, ind) => {
                if (ind !== ship.length - 1) {
                    document.getElementById("field")?.childNodes.forEach((element, index) => {
                        if (index === el) {
    ...
    renderAroundSmallShip(ship: number[]) {
        ...
        } else if (smallShip > 0 && smallShip < 9) {
            this.addBackgroundAroundSmallShip({
                first: smallShip,
                second: smallShip + 1,
                third: smallShip - 1,
        ...
        } else if (smallShip > 90 && smallShip < 99) {
            this.addBackgroundAroundSmallShip({
                first: smallShip,
                second: smallShip + 1,
                third: smallShip - 1,
    ...
    renderAroundShipVertical(ship: number[]) {
        ...
        } else if (ship[0] + shipLength * 10 === 90) {
            ship.forEach((el) => {
                (cellsShip[el] as HTMLElement).style.background = this.backgroundAroundShip;
                this.backgroundAroundShips[this.backgroundAroundShips.length - 1].push(el);
                (cellsShip[el + 1] as HTMLElement).style.background = this.backgroundAroundShip;
        ...
        } else if (ship[0] + shipLength * 10 === 99) {
            ship.forEach((el) => {
                (cellsShip[el] as HTMLElement).style.background = this.backgroundAroundShip;
                this.backgroundAroundShips[this.backgroundAroundShips.length - 1].push(el);
                (cellsShip[el - 1] as HTMLElement).style.background = this.backgroundAroundShip;
        ...
        } else if (ship[0] + shipLength * 10 > 90 && ship[0] + shipLength * 10 < 99) {
            ship.forEach((el) => {
                (cellsShip[el] as HTMLElement).style.background = this.backgroundAroundShip;
                this.backgroundAroundShips[this.backgroundAroundShips.length - 1].push(el);
                (cellsShip[el - 1] as HTMLElement).style.background = this.backgroundAroundShip;
